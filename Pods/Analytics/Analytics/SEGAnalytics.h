...
/**
* This object provides a set of properties to control various policies of the analytics client. Other than `token`, these properties can be changed at any time.
*/
...
*
* @param token Your project's write key from segment.io.
*/
...
+ (void)initializeWithToken:(NSString *)token __attribute__((deprecated("Use +setupWithConfiguration: instead")));
- (id)initWithToken:(NSString *)token __attribute__((deprecated("Use -initWithConfiguration: instead")));
